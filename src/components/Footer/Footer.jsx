    ...
    <footer>
      ...
      <figure className="img-container">
        <a href="https://github.com/PaulaCR90">
          <img src="/src/assets/github.png" alt="Enlace a Github" />
        </a>
        <a href="https://www.linkedin.com/in/alejandra-castro-rodr%C3%ADguez-a671b3208/">
          <img src="/src/assets/linkedin.png" alt="Enlace a Linkedin" />
        </a>
        <a href="mailto:p.a.castrorodriguez@gmail.com">
          <img src="/src/assets/correo-electronico.png" alt="Enlace a e-mail" />
        </a>
      </figure>
    </footer>
  );
